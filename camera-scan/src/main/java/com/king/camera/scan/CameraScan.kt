...
abstract class CameraScan<T> : ICamera, ICameraControl {
    ...
    companion object {
         ...
         * 纵横比：4:3
         */
        const val ASPECT_RATIO_4_3: Float = 4.0F / 3.0F

        /**
         * 纵横比：16:9
         */
        const val ASPECT_RATIO_16_9: Float = 16.0F / 9.0F
     ...
     * 是否需要支持触摸缩放
     */
    private var isNeedTouchZoom: Boolean = true
     ...
     * @return 返回是否需要支持触摸缩放
     */
    protected fun isNeedTouchZoom(): Boolean = isNeedTouchZoom
